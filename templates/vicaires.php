...
<head>
    ...
    <title>Les Vicaires Paroissiaux</title>
                ...
                <ul class="nav-links">
                    ...
                    <li>
                        ...
                        <ul class="dropdown">
                            ...
                            <li><a class="activ" href="">Les Vicaires Paroissiaux</a></li>
...
<section class="home-section"> 
    <div class="home-text fade-in">
        <h1>Les Vicaires Paroissiaux</h1>
    </div>
    <div class="home-images">
        <div class="gradient-overlay"></div>
        <img class="home-bg" src="../asset/images/priest/vicariat_upc.jpeg" alt="Image d'église">
    </div>
</section>

<section class="paroisses">
    <div class="container">
        <p class="section-subtitle">Découvrez les Vicaires Paroissiaux et leurs responsabilités</p>
        ...
        <div class="paroisses-list">
            <?php
                ...
                if(!$results){
                    ?><p>Aucun vicaire ajoutée</p><?php
                }else{
                    foreach($results as $result){
                        ?>
                            <div class="paroisse">
                                <img src="vicaires_images/<?=$result['photo']?>" alt="Photo de vicaire <?=$result['name']?>">
                                <h3><?=$result['name']?></h3>
                                <p><?=$result['title']?></p>
                            </div>
                        <?php
