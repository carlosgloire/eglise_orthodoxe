                ...
                <ul class="nav-links">
                    ...
                    <li>
                        ...
                        <ul class="dropdown">
                            ...
                            <li><a class="activ" href="#">Métropolite</a></li>
...
<section class="home-section"> 
    <div class="home-text fade-in">
        <h1>Métropolites de la Sainte Famille</h1>
    </div>
...
<section class="paroisses">
    <div class="container">
        <p class="section-subtitle"> Métropolite au service de la Sainte Famille</p>
        ...
        <div class="paroisses-list">
            <?php
                ...
                if(!$results){
                    ?><p>Aucun métropolite ajouté</p><?php
                }else{
                    foreach($results as $result){
                        ?>
                            <div class="paroisse">
                                <img src="metropolites_images/<?=$result['photo']?>" alt="Photo du métropolite <?=$result['name']?>">
                                <h3><?=$result['name']?></h3>
                            </div>
                        <?php
                    }
