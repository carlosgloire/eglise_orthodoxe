                ...
                <ul class="nav-links">
                    ...
                    <li>
                        ...
                        <ul class="dropdown">
                            ...
                            <li><a class="activ" href="">Diacres</a></li>
...
<section class="home-section"> 
    <div class="home-text fade-in">
        <h1>Les Diacres de la Sainte Famille</h1>
    </div>
...
<section class="paroisses">
    <div class="container">
        <p class="section-subtitle"> Diacres au service de la Sainte Famille</p>
            ...
            <?php
                ...
                if(!$results){
                    ...
                    foreach($results as $result){
                        ?>
                            <div class="paroisse">
                                <img src="diacres_images/<?=$result['photo']?>" alt="Photo du diacre <?=$result['name']?>">
                                <h3><?=$result['name']?></h3>
                            </div>
                        <?php
                    }
