        ...
        <div class="menu-bar">
            ...
            <nav>
                <ul class="nav-links">
                    ...
                    <li>
                        <a href="#" class="activ">ORGANISATION</a>
                        <ul class="dropdown">
                            <li><a class="activ" href="patriaches.php">Patriarches </a></li>
...
<section class="home-section"> 
    <div class="home-text fade-in">
        <h1>Les Patriaches de la Sainte Famille</h1>
    </div>
    <div class="home-images">
        <div class="gradient-overlay"></div>
        <img class="home-bg" src="../asset/images/orthodox-ritual-church-candles-fire-wax.jpg" alt="Image d'église">
    </div>
</section>

<section class="paroisses">
    <div class="container">
        <p class="section-subtitle">Communauté des patriaches au service de la Sainte Famille</p>
        ...
        <div class="paroisses-list">
            <?php
                ...
                if(!$results){
                    ?><p>Aucun patriarches ajouté</p><?php
                }else{
                    foreach($results as $result){
                        ?>
                            <div class="paroisse">
                                <img src="patriarches_images/<?=$result['photo']?>" alt="Photo du patriarches <?=$result['name']?>">
                                <h3><?=$result['name']?></h3>
                            </div>
                        <?php
                    }
