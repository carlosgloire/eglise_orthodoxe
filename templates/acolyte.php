                ...
                <ul class="nav-links">
                    ...
                    <li>
                        ...
                        <ul class="dropdown">
                            ...
                            <li><a class="activ" href="">Acolytes</a></li>
                        </ul>
                    </li>
...
<section class="home-section"> 
    <div class="home-text fade-in">
        <h1>Les Acolytes de la Sainte Famille</h1>
    </div>
    <div class="home-images">
        <div class="gradient-overlay"></div>
        <img class="home-bg" src="../asset/images/background/acolyte.jpg" alt="Image d'église">
    </div>
</section>

<section class="paroisses">
    <div class="container">
        <p class="section-subtitle"> Acolytes au service de la Sainte Famille</p>
            ...
            <?php
                ...
                if(!$results){
                    ...
                    foreach($results as $result){
                        ?>
                            <div class="paroisse">
                                <img src="acolytes_images/<?=$result['photo']?>" alt="Photo de l'acolyte <?=$result['name']?>">
                                <h3><?=$result['name']?></h3>
                            </div>
                        <?php
                    }
