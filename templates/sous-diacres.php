                ...
                <ul class="nav-links">
                    ...
                    <li>
                        ...
                        <ul class="dropdown">
                            ...
                            <li><a class="activ"  href="">Sous Diacres</a></li>
...
<section class="home-section"> 
    <div class="home-text fade-in">
        <h1>Les Sous Diacres de la Sainte Famille</h1>
    </div>
    <div class="home-images">
        <div class="gradient-overlay"></div>
        <img class="home-bg" src="../asset/images/background/Diacres.jpg" alt="Image d'église">
    </div>
</section>

<section class="paroisses">
    <div class="container">
        <p class="section-subtitle"> Sous Diacres au service de la Sainte Famille</p>
            ...
            <?php
                ...
                if(!$results){
                    ...
                    foreach($results as $result){
                        ?>
                            <div class="paroisse">
                                <img src="sous_diacres_images/<?=$result['photo']?>" alt="Photo du sous diacre <?=$result['name']?>">
                                <h3><?=$result['name']?></h3>
                            </div>
                        <?php
                    }
