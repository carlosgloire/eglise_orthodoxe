                ...
                <ul class="nav-links">
                    ...
                    <li>
                        ...
                        <ul class="dropdown">
                            ...
                            <li><a href="priests.php" class="activ">Les Prêtres</a></li>
...
<section class="home-section"> 
    <div class="home-text fade-in">
        <h1>Les Prêtres de la Sainte Famille</h1>
    </div>
    <div class="home-images">
        <div class="gradient-overlay"></div>
        <img class="home-bg" src="../asset/images/priest/priests.png" alt="Image d'église">
    </div>
</section>

<section class="paroisses">
    <div class="container">
        <p class="section-subtitle">Communauté des prêtres au service de la Sainte Famille</p>
        ...
        <div class="paroisses-list">
            <?php
                ...
                if(!$results){
                    ?><p>Aucun prêtre ajouté</p><?php
                }else{
                    foreach($results as $result){
                        ?>
                            <div class="paroisse">
                                <img src="pretres_images/<?=$result['photo']?>" alt="Photo de prêtre <?=$result['name']?>">
                                <h3><?=$result['name']?></h3>
                                <p><?=$result['title']?></p>
                            </div>
                        <?php
