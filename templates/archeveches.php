                ...
                <ul class="nav-links">
                    ...
                    <li>
                        ...
                        <ul class="dropdown">
                            ...
                            <li><a  class="activ" href="#">Archevêchés</a></li>
...
<section class="home-section"> 
    <div class="home-text fade-in">
        <h1>Les Archevêchés de la Sainte Famille</h1>
    </div>
...
<section class="paroisses">
    <div class="container">
        <p class="section-subtitle"> Évêques au service de la Sainte Famille</p>
        ...
        <div class="paroisses-list">
            <?php
                ...
                if(!$results){
                    ?><p>Aucun Évêques ajouté</p><?php
                }else{
                    foreach($results as $result){
                        ?>
                            <div class="paroisse">
                                <img src="archeveques_images/<?=$result['photo']?>" alt="Photo d'Évêque <?=$result['name']?>">
                                <h3><?=$result['name']?></h3>
                                <p><?=$result['title']?></p>
                            </div>
                        <?php
