...
<head>
    ...
    <title>Les Sœurs Religieuses</title>
                ...
                <ul class="nav-links">
                    ...
                    <li>
                        ...
                        <ul class="dropdown">
                            ...
                            <li><a href="#" class="activ">Soeurs Religieuses</a></li>
...
<section class="home-section"> 
    <div class="home-text fade-in">
        <h1>Communauté des Sœurs</h1>
    </div>
    <div class="home-images">
        <div class="gradient-overlay"></div>
        <img class="home-bg" src="../asset/images/priest/soeurs.jpg" alt="Image d'église">
    </div>
</section>

<section class="paroisses">
    <div class="container">
        <p class="section-subtitle">Communauté des Sœurs de la Sainte Famille de Nazareth</p>
        ...
        <div class="paroisses-list">
            <?php
                ...
                if(!$results){
                    ?><p>Aucune soeur ajoutée</p><?php
                }else{
                    foreach($results as $result){
                        ?>
                            <div class="paroisse">
                                <img src="soeurs_images/<?=$result['photo']?>" alt="Photo de Sœur <?=$result['name']?>">
                                <h3><?=$result['name']?></h3>
                                <p><?=$result['title']?></p>
                            </div>
                        <?php
