...
if (isset($_POST['add'])) {
    ...
    $folder = "../templates/activities_background/" . $filename;
    ...
    if (empty($filename)) {
        ...
        $existing_product_query = $db->prepare("SELECT * FROM activities_background WHERE photo=:photo");
        ...
        if ($existing_product) {
            ...
            $query = $db->prepare('INSERT INTO activities_background (photo) VALUES (:photo)');
