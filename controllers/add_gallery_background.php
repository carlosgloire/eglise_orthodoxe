...
if (isset($_POST['add'])) {
    ...
    $folder = "../templates/gallery_background/" . $filename;
    ...
    if (empty($filename)) {
        ...
        $existing_product_query = $db->prepare("SELECT * FROM gallery_background WHERE photo=:photo");
        ...
        if ($existing_product) {
            ...
            $query = $db->prepare('INSERT INTO gallery_background (photo) VALUES (:photo)');
