<?php 
       session_start();
    require_once('../controllers/edit_metropolite.php');
...
<head>
    ...
    <title>Modifier un métropolite</title>
        ...
        <div class="second-bloc">
            <div class="formulaire-form">
                <form action="" method="post" enctype="multipart/form-data">
                    <h3>Modifier le métropolite</h3>

                    <p style="text-align: left;margin-top: 10px;">Modifier la photo du métropolite</p>
                    <div class="all-inputs">
                        <input type="file" name="uploadfile">
                    </div>
                    
                    <div class="all-inputs">
                        <input type="text" name="name" value="<?= htmlspecialchars($metropolite['name']) ?>" placeholder="Nom du métropolite">
                    </div>
