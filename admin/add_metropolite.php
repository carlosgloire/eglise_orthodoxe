<?php 
       session_start();
    require_once('../controllers/add_metropolite.php');
...
<head>
    ...
    <title>Ajouter un métropolite</title>
        ...
        <div class="second-bloc">
            <div class="formulaire-form">
                <form action="" method="post" enctype="multipart/form-data">
                    <h3>Ajouter un métropolite</h3>

                    <p style="text-align: left;margin-top: 10px;">Ajouter une photo du métropolite</p>
                    <div class="all-inputs">
                        <input type="file" name="uploadfile">
                    </div>
                    <div class="all-inputs">
                        <input type="text" name="name" placeholder="Nom du métropolite">
                    </div>
                    <div class="submit">
