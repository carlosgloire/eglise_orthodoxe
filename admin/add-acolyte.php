<?php 
    require_once('../controllers/add_acolyte.php');
...
<head>
    ...
    <title>Ajouter un Acolyte</title>
        ...
        <div class="second-bloc">
            <div class="formulaire-form">
                <form action="" method="post" enctype="multipart/form-data">
                    <h3>Ajouter un Acolyte</h3>
                    <p>Ajouter une photo de l'Acolyte</p>
                    <div class="all-inputs">
                        <input type="file" name="uploadfile">
                    </div>
                    <div class="all-inputs">
                        <input type="text" name="name" placeholder="Nom de l'Acolyte">
                    </div>
                    <div class="submit">
