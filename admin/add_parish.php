<?php 
    require_once('../controllers/add_parish.php');
...
<head>
    ...
    <title>Ajouter une Paroisse</title>
        ...
        <div class="second-bloc">
            <div class="formulaire-form">
                <form action="" method="post" enctype="multipart/form-data">
                    <h3>Ajouter une Paroisse</h3>
                    <p style="text-align: left; margin-top: 10px;">Ajouter une nouvelle paroisse</p>
                    <div class="all-inputs">
                        <input type="file" name="uploadfile">
                    </div>
                    <div class="all-inputs">
                        <input type="text" name="parish_name" placeholder="Nom de la paroisse">
                    </div>
                    <div class="all-inputs">
                        <input type="text" name="leaders" placeholder="Responsables">
                    </div>
                    <div class="submit">
