<?php 
    require_once('../controllers/add_diacre.php');
        ...
        <div class="second-bloc">
            <div class="formulaire-form">
                <form action="" method="post" enctype="multipart/form-data">
                    <h3>Ajouter un Diacre</h3>
                    <p>Ajouter une photo du Diacre</p>
                    <div class="all-inputs">
                        <input type="file" name="uploadfile">
                    </div>
                    <div class="all-inputs">
                        <input type="text" name="name" placeholder="Nom du Diacre">
                    </div>
                    <div class="submit">
