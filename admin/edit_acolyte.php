<?php 
       session_start();
    require_once('../controllers/edit_acolyte.php');
...
<head>
    ...
    <title>Modifier un acolyte</title>
        ...
        <div class="second-bloc">
            <div class="formulaire-form">
                <form action="" method="post" enctype="multipart/form-data">
                    <h3>Modifier un Acolyte</h3>
                    <p>Modifier la photo de l'Acolyte</p>
                    <div class="all-inputs">
                        <input type="file" name="uploadfile">
                    </div>
                    <div class="all-inputs">
                        <input type="text" name="name" value="<?= $acolyte['name'] ?>" placeholder="Nom de l'Acolyte">
                    </div>
                    <div class="submit">
