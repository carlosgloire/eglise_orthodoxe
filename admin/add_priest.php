<?php 
    require_once('../controllers/add_priest.php');
        ...
        <div class="second-bloc">
            <div class="formulaire-form">
                <form action="" method="post" enctype="multipart/form-data">
                    <h3>Ajouter un Prêtre</h3>
                    <p>Ajouter une photo du Prêtre</p>
                    <div class="all-inputs">
                        <input type="file" name="uploadfile">
                    </div>
                    <div class="all-inputs">
                        <input type="text" name="name" placeholder="Nom du Prêtre">
                    </div>
                    <div class="all-inputs">
