<?php 
    require_once('../controllers/edit_diacre.php');
...
<head>
    ...
    <title>Modifier un diacre</title>
        ...
        <div class="second-bloc">
            <div class="formulaire-form">
                <form action="" method="post" enctype="multipart/form-data">
                    <h3>Modifier un Diacre</h3>
                    <p>Modifier la photo du Diacre</p>
                    <div class="all-inputs">
                        <input type="file" name="uploadfile">
                    </div>
                    <div class="all-inputs">
                        <input type="text" name="name" value="<?= $diacre['name'] ?>" placeholder="Nom du Diacre">
                    </div>
                    <div class="submit">
