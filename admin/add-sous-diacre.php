<?php 
    require_once('../controllers/add-sous-diacre.php');
...
<head>
    ...
    <title>Ajouter un Sous-Diacre</title>
        ...
        <div class="second-bloc">
            <div class="formulaire-form">
                <form action="" method="post" enctype="multipart/form-data">
                    <h3>Ajouter un Sous-Diacre</h3>
                    <p>Ajouter une photo du Sous-Diacre</p>
                    <div class="all-inputs">
                        <input type="file" name="uploadfile">
                    </div>
                    <div class="all-inputs">
                        <input type="text" name="name" placeholder="Nom du Sous-Diacre">
                    </div>
                    <div class="submit">
