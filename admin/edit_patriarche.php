<?php 
       session_start();
    require_once('../controllers/edit_patriarche.php');
...
<head>
    ...
    <title>Modifier le patriarche</title>
    ...
    <section class="admin-section">
        ...
        <div class="formulaire-form">
            <form action="" method="post" enctype="multipart/form-data">
                <h3>Modifier le patriarche</h3>

                <p style="text-align: left;margin-top: 10px;">Modifier la photo du patriarche</p>
                <div class="all-inputs">
                    <input type="file" name="uploadfile">
                </div>
                
                <div class="all-inputs">
                    <input type="text" name="name" value="<?= htmlspecialchars($patriarch['name']) ?>" placeholder="Nom du patriarche">
                </div>
