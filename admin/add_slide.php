<?php 
       session_start();
    require_once('../controllers/add_slide.php');
    ...
    <section class="admin-section">
        <div class="first-bloc">
            <nav>
                ...
                <a class="activ" href="home_slide_images.php">
        ...
        <div class="second-bloc">
            <div class="formulaire-form">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <p style="text-align: left;margin-top: 10px;">Veillez choisir une image pour le fond</p>
