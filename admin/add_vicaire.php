<?php 
    session_start();
    require_once('../controllers/add_vicaire.php');
...
<head>
    ...
    <title>Ajouter un Vicaire</title>
        ...
        <div class="second-bloc">
            <div class="formulaire-form">
                <form action="" method="post" enctype="multipart/form-data">
                    <h3>Ajouter un Vicaire</h3>
                    <p>Ajouter une photo du Vicaire</p>
                    <div class="all-inputs">
                        <input type="file" name="uploadfile">
                    </div>
                    <div class="all-inputs">
                        <input type="text" name="name" placeholder="Nom du Vicaire">
                    </div>
                    <div class="all-inputs">
