<?php 
    require_once('../controllers/edit_priest.php');
...
<head>
    ...
    <title>Modifier un  Prêtre</title>
        ...
        <div class="second-bloc">
            <div class="formulaire-form">
                <form action="" method="post" enctype="multipart/form-data">
                    <h3>Modifier le Prêtre</h3>

                    <p>Modifier la photo du Prêtre</p>
                    <div class="all-inputs">
                        <input type="file" name="uploadfile">
                    </div>
                    
                    <div class="all-inputs">
                        <input type="text" name="name" value="<?= htmlspecialchars($prete['name']) ?>" placeholder="Nom du Prêtre">
                    </div>
                    
                    <div class="all-inputs">
                        <input type="text" name="title" value="<?= htmlspecialchars($prete['title']) ?>" placeholder="Son titre">
                    </div>
