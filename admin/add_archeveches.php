<?php 
    require_once('../controllers/add_archeveque.php');
...
<head>
    ...
    <title>Ajouter l'Archevêque</title>
        ...
        <div class="second-bloc">
            <div class="formulaire-form">
                <form action="" method="post" enctype="multipart/form-data">
                    <h3>Ajouter un Archevêque</h3>
                    <p>Ajouter une photo de l'Archevêque</p>
                    <div class="all-inputs">
                        <input type="file" name="uploadfile">
                    </div>
                    <div class="all-inputs">
                        <input type="text" name="name" placeholder="Nom de l'Archevêque">
                    </div>
                    <div class="all-inputs">
                        <input type="text" name="title" placeholder="Son titre">
                    </div>
                    <div class="submit">
