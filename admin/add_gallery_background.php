<?php 
       session_start();
    require_once('../controllers/add_gallery_background.php');
...
<head>
    ...
    <title>Ajouter une image de fond galerie</title>
        ...
        <div class="second-bloc">
            <div class="formulaire-form">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <p style="text-align: left;margin-top: 10px;">Ajouter une image de fond pour la galerie</p>
