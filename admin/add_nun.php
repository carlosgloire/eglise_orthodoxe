<?php 
    require_once('../controllers/add_nun.php');
...
<head>
    ...
    <title>Ajouter une Sœur Religieuse</title>
        ...
        <div class="second-bloc">
            <div class="formulaire-form">
                <form action="" method="post" enctype="multipart/form-data">
                    <h3>Ajouter une Sœur Religieuse</h3>
                    <p>Ajouter une photo de la Sœur</p>
                    <div class="all-inputs">
                        <input type="file" name="uploadfile">
                    </div>
                    <div class="all-inputs">
                        <input type="text" name="name" placeholder="Nom de la Sœur">
                    </div>
                    <div class="all-inputs">
