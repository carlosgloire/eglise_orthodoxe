...
<body>
    ...
    <section class="admin-section">
        ...
        <div class="second-bloc">
            <p style="margin-left: 20px;margin-right:20px;margin-top:15px">Dans cette section vous pouvez gérer les images de fond, soit les supprimer ou les ajouter</p>
            <div class="image-details">
                <div class="bouttons" >
                    <div class="add-image">
                        <a href="add_slide.php">Ajouter un  fond</a>
                    </div>
                </div>
                <div class="image-items">
                    <?php
                        ...
                        if( empty($photos)){
                            ?><p>Aucune photo ajoutée pour le fond</p><?php
                        }else{
                            foreach($photos as $photo){
                            ?>
                                <div>
                                    <p><img src="../templates/slide_images/<?=$photo['photo']?>" alt=""></p>
    ...
    <script src="../asset/javascript/delete_slide.js"></script>
</body>
</html>