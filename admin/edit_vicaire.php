<?php 
    require_once('../controllers/edit_vicaire.php');
...
<head>
    ...
    <title>Modifier un vicaire</title>
        ...
        <div class="second-bloc">
            <div class="formulaire-form">
                <form action="" method="post" enctype="multipart/form-data">
                    <h3>Modifier un Vicaire</h3>
                    <p>Modifier la photo</p>
                    <div class="all-inputs">
                        <input type="file" name="uploadfile">
                    </div>
                    <div class="all-inputs">
                        <input type="text" name="name" value="<?= $vicaire['name'] ?>" placeholder="Nom du Vicaire">
                    </div>
                    <div class="submit">
