<?php 
       session_start();
    require_once('../controllers/edit_sous_diacre.php');
...
<head>
    ...
    <title>Modifier un sous diacre</title>
        ...
        <div class="second-bloc">
            <div class="formulaire-form">
                <form action="" method="post" enctype="multipart/form-data">
                    <h3>Modifier un Sous-Diacre</h3>
                    <p>Modifier la photo du Sous-Diacre</p>
                    <div class="all-inputs">
                        <input type="file" name="uploadfile">
                    </div>
                    <div class="all-inputs">
                        <input type="text" name="name" value="<?= $sous_diacre['name'] ?>" placeholder="Nom du Sous-Diacre">
                    </div>
                    <div class="submit">
