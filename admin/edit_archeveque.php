<?php 
    require_once('../controllers/edit_archeveque.php');
...
<head>
    ...
    <title>Modifier l'Archevêque</title>
        ...
        <div class="second-bloc">
            <div class="formulaire-form">
                <form action="" method="post" enctype="multipart/form-data">
                    <h3>Modifier l'Archevêque</h3>

                    <p>Modifier la photo de l'Archevêque</p>
                    <div class="all-inputs">
                        <input type="file" name="uploadfile">
                    </div>
                    
                    <div class="all-inputs">
                        <input type="text" name="name" value="<?= htmlspecialchars($archeveque['name']) ?>" placeholder="Nom de l'Archevêque">
                    </div>
                    
                    <div class="all-inputs">
                        <input type="text" name="title" value="<?= htmlspecialchars($archeveque['title']) ?>" placeholder="Son titre">
                    </div>

                    <div class="submit">
                        <input name="edit" type="submit" value="Mettre à jour">
                    </div>
