<?php 
    require_once('../controllers/edit_parish.php');
...
<head>
    ...
    <title>Modifier une Paroisse</title>
        ...
        <div class="second-bloc">
            <div class="formulaire-form">
                <form action="" method="post" enctype="multipart/form-data">
                    <h3>Modifier une Paroisse</h3>
                    <div class="all-inputs">
                        <input type="file" name="uploadfile">
                    </div>
                    <div class="all-inputs">
                        <input type="text" name="parish_name"  value="<?= htmlspecialchars($parish['parish_name'] ?? '') ?>">
                    </div>
                    <div class="all-inputs">
                        <input type="text" name="leaders" value="<?= htmlspecialchars($parish['leaders'] ?? '') ?>">
                    </div>
                    <div class="submit">
