...
<body>
    ...
    <section class="admin-section">
        <div class="first-bloc">
            <nav>
                ...
                <a class="activ"  href="paroisses.php">
        ...
        <div class="second-bloc">
            <p style="margin-left: 20px;margin-right:20px;margin-top:15px">Dans cette section vous pouvez gérer les paroisses, soit les supprimer, les modifier ou les ajouter</p>
            <div class="image-details">
                <div class="bouttons" >
                    <div class="add-image">
                        <a href="add_parish.php">Ajouter une paroisse</a>
                    </div>
                </div>
                <div class="paroisses">
                    <div class="container">
                            ...
                            <?php
                                ...
                                if(!$parishes){
                                    ...
                                    foreach($parishes as $parish){
                                        ?>
                                            <div class="paroisse">
                                                <img src="../templates/images_paroisses/<?=$parish['photo']?>" alt="Image <?=$parish['parish_name']?>">
                                                <h3><?=$parish['parish_name']?></h3>
                                                <p><?=$parish['leaders']?></p>
                                                <div class="buttons" style="font-size: 16px;">
                                                    <i class="bi bi-trash3 delete delete-image"  gallery_id="<?= $parish['id'] ?>" title="Supprimer"></i>
                                                    <a class="edit" href="edit_parish.php?id=<?=$parish['id']?>"><i class="bi bi-pen" title="Modifier"></i></a>
                                                </div>
                                            </div>
                                        <?php
                                    }
    ...
    <script src="../asset/javascript/delete_parish.js"></script>
</body>
</html>